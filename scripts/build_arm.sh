...
echo ""
echo "========================================="
echo "Optional: Build with TETRA Decryption"
echo "========================================="
echo ""
echo "⚠️  LEGAL WARNING: Unauthorized use is ILLEGAL"
echo ""
echo "To enable TETRA TEA1 decryption (educational/authorized use ONLY):"
echo "  cd build"
echo "  cmake .. -DENABLE_TETRA_DECRYPTION=ON"
echo "  make -j$NPROC"
echo ""
echo "See docs/european/TETRA_REALTIME_DECRYPTION.md for details"
echo ""
